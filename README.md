# SheLLM
A prototype work in progress .sh to run a Zenity-Based easy LLM terminal installer for Open-AI LLM Compatible API Endpoints for easy installation in many common Linux terminals
...
If your package manager is not listed, you can install `curl` and `python3` manually and re-run the setup script.
...
**Do not run as root.** Run as your normal user account.
